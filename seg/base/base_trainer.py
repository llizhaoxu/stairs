...
from seg.utils import helpers
from seg.utils import logger
import seg.utils.lr_scheduler
from seg.utils.sync_batchnorm import convert_model
from seg.utils.sync_batchnorm import DataParallelWithCallback
...
class BaseTrainer:
    def __init__(self, model, loss, resume, config, train_loader, val_loader=None, train_logger=None):
        ...
        self.lr_scheduler = getattr(seg.utils.lr_scheduler, config['lr_scheduler']['type'])(self.optimizer, self.epochs, len(train_loader))
